...
1. Update configuration files with absolute paths for your system:  
...
2. Set your reaction and stock preferences in **`config/config_synthsense.yml`**.
...
SynthSense integrates with REINVENT4 as a scoring component:
